...
namespace Lib\Classes\Validation;

use Lib\Classes\Validation\Rules\Required;
use Closure;
use Lib\Classes\Validation\Rules\Defaults;
        ...
        foreach($rules as $ruleValidator) {
            ...
            */
            ...
            if (!$valid) {
                ...
                //If this rule fail then ignore other rule
				//Add this line by suhern
				break;
    ...
    protected function resolveRules($rules)
    {
        ...
        foreach($rules as $i => $rule) {
            ...
            if (is_string($rule)) {
                ...
                throw new \Exception("Rule must be a string, closure or Lib\Classes\Validation\Rule instance. ".$ruleName." given");
            }
