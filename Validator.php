...
class Validator
{
	...
	// change default value to false by suhern
    //protected $useHumanizedKeys = true;
	protected $useHumanizedKeys = false;
    ...
    protected function registerBaseValidators()
    {
        $baseValidator = [
			...
			//Add custom rule by suhern
			'strict_int' 				=> new Rules\StrictInt,
			'assoc_ary'					=> new Rules\AssocAry,
			'pure_ary'					=> new Rules\PureAry,
        ];
	...
	public function setUseHumanizedKeys($useHumanizedKeys = false)
    {
